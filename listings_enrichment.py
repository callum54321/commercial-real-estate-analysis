...
import os
from scraped_data_cleaning import df
...
# Place type list and storage
place_types = ["gym", "cafe", "restaurant"]
amenity_counts = {place: [] for place in place_types}

# Deduplicate building names for api call
unique_locations = df.drop_duplicates(subset=["bldg_name", "district"])[["bldg_name", "district"]].copy()
